		...
		<form:form modelAttribute="order.customer" class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="doorNo" path="address.doorNo" type="text"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="streetName" path="address.streetName" type="text"
							class="form:input-large" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="areaName" path="address.areaName" type="text"
							class="form:input-large" />
					</div>
				</div>
